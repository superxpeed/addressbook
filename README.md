...
4. [**Spring Web**](https://docs.spring.io/spring/docs/current/spring-framework-reference/web.html)
    -   [Exception handler for all back-end exceptions](https://github.com/dredwardhyde/addressbook/blob/master/addressbook-main/src/main/kotlin/com/addressbook/aop/ControllerExceptionHandler.kt) including [request filters](https://github.com/dredwardhyde/addressbook/blob/master/addressbook-main/src/main/kotlin/com/addressbook/security/JwtFilter.kt#L38)   
    ...
    -   [Uploading](https://github.com/dredwardhyde/addressbook/blob/master/addressbook-main/src/main/kotlin/com/addressbook/rest/MainController.kt#L176) and [downloading](https://github.com/dredwardhyde/addressbook/blob/master/addressbook-main/src/main/kotlin/com/addressbook/rest/MainController.kt#L203) files with [SHA256 checksum verification](https://github.com/dredwardhyde/addressbook/blob/master/addressbook-main/src/main/kotlin/com/addressbook/util/Utils.kt#L15) and [progress control using Axios](https://github.com/dredwardhyde/addressbook/blob/master/addressbook-main/src/main/react/src/Components/PersonComponent.js#L583)
5. [**Spring Flux**](https://docs.spring.io/spring/docs/current/spring-framework-reference/web-reactive.html) for [reactive updates](https://github.com/dredwardhyde/addressbook/blob/master/addressbook-main/src/main/kotlin/com/addressbook/services/JVMStateService.kt) on [front-end](https://github.com/dredwardhyde/addressbook/blob/master/addressbook-main/src/main/react/src/Pages/AdminForm.js#L34)
...
7. [**Apache Ignite**](https://apacheignite.readme.io/docs) [server configuration](https://github.com/dredwardhyde/addressbook/blob/master/ignite-server/src/main/kotlin/com/addressbook/server/dao/DAO.kt#L40), [generic SQL queries](https://github.com/dredwardhyde/addressbook/blob/master/ignite-server/src/main/kotlin/com/addressbook/server/dao/DAO.kt#L372), [transactions](https://github.com/dredwardhyde/addressbook/blob/master/ignite-server/src/main/kotlin/com/addressbook/server/dao/DAO.kt#L119), [binary marshalling](https://github.com/dredwardhyde/addressbook/blob/master/addressbook-common/src/main/kotlin/com/addressbook/model/AddressBookEntities.kt#L188)
...
2.  [**Kubernetes** templates:](https://github.com/dredwardhyde/addressbook/tree/master/devops/templates)
    ...
    - **Secret** as [**Volume**](https://github.com/dredwardhyde/addressbook/blob/master/devops/templates/web/dp-web.yaml#L82)
    - **Secret** as [**ConfigMap**](https://github.com/dredwardhyde/addressbook/blob/master/devops/templates/web/dp-web.yaml#L69)
    ...
    - [**Fluent Bit sidecar**](https://github.com/dredwardhyde/addressbook/blob/master/devops/templates/web/dp-web.yaml#L93)  
...
7.  [**Building Docker images with Maven**](https://github.com/dredwardhyde/addressbook/blob/master/addressbook-main/pom.xml#L433)  
