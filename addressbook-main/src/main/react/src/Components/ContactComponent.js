            ...
            <Panel style={{marginBottom: '5px'}}>
                <Panel.Heading>
                    ...
                    <Button style={{
                        ...
                        position: 'relative',
                        padding: '6px'
                    }} onClick={this.props.deleteContact.bind(null, {id: this.props.id})}>X</Button>
                </Panel.Heading>
                <Panel.Body collapsible>
                    <FormControl id='type' style={{marginTop: '5px'}} componentClass='select' value={this.state.type}
