...
export const UPLOAD_DOCUMENT: string = `${cp}rest/uploadDocument`;
export const DELETE_DOCUMENT: string = `${cp}rest/deleteDocument`;
export const GET_DOCUMENT_LIST: string = `${cp}rest/getDocumentList`;
